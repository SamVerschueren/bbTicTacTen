/****************************************************************************
** Meta object code from reading C++ file 'ViewModel.hpp'
**
...
#include "../../../src/ViewModels/ViewModel.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ViewModel.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_ViewModel[] = {
    "ViewModel\0\0state\0stateChanged(int)\0"
    "int\0"
};
...
const QMetaObject ViewModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ViewModel,
...
// SIGNAL 0
void ViewModel::stateChanged(int _t1)
{
